...
node business/plimsoll/product/plimsoll/src/cli.mjs /path/to/repo --since "12 months ago"

# The business: 24-month operating model
node business/plimsoll/model/run.mjs

# Tests
node --test 'business/plimsoll/product/plimsoll/test/*.test.mjs'
node --test 'business/plimsoll/model/test/*.test.mjs'
```
